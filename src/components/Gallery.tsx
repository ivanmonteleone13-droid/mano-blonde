    ...
    <section id="galleri" className="bg-[var(--dark)] py-20 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">Blond & balayage</h2>
          <p className="mt-4 text-white/80">Riktiga bilder från {business.name} — klicka för att förstora.</p>
        </div>
      ...
      {active && activeIndex !== null && hasSingleImage(active) && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 p-4" role="dialog" aria-modal="true" onClick={close}>
