        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="aspect-[4/5] overflow-hidden rounded-3xl shadow-xl">
            {aboutImage ? (
              ...
              <div className="flex h-full items-center justify-center bg-gradient-to-br from-[var(--primary)] to-[var(--secondary)]/30 text-6xl" aria-hidden>
                ✨
              </div>
            )}
          </div>
          <div>
            <p className="text-sm font-semibold uppercase tracking-wider text-[var(--primary)]">Om oss</p>
            <h2 className="mt-2 text-3xl font-bold text-[var(--dark)] sm:text-4xl">{business.about.headline}</h2>
            <div className="mt-6 space-y-4 text-[var(--dark)]/80 leading-relaxed">
            ...
            <div className="mt-6 rounded-2xl border border-[var(--primary)]/10 bg-[var(--accent)] px-6 py-4">
              ...
              <p className="text-sm text-[var(--dark)]/70">{business.reviewCount}+ omdömen på Bokadirekt · Grundad av Amanda</p>
            </div>
